...
namespace HSharp.Util
{
    ...
    public class ExcelHelper<T> where T : new()
    {
        ...
        public string ExportToExcel(string sFileName, string sHeaderText, List<T> list, string[] columns)
        {
            ...
            string sRoot = GlobalContext.HostEnvironment?.ContentRootPath;
        ...
        {
            string absoluteFilePath = GlobalContext.HostEnvironment?.ContentRootPath + filePath.Replace(Path.AltDirectorySeparatorChar, Path.DirectorySeparatorChar);
