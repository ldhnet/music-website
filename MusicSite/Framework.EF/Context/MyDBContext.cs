        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            { 
                if (string.IsNullOrEmpty(_connectionString))
                {
                    ...
                    // _connectionString = "server=sh-cynosdbmysql-grp-brbuc2xq.sql.tencentcdb.com;userid=root;pwd=Dsb0004699;port=21952;database=ldh;Convert Zero Datetime=True;Allow User Variables=True;sslMode=None";
                }
